pos_adj = [(*@\label{code:tempex:posadj:1}@*)'good', 'great', 'excellent', 'amazing', ...](*@\label{code:tempex:posadj:2}@*)
neg_adj = [(*@\label{code:tempex:negadj:1}@*)'awful', 'bad', 'horrible', 'weird', ...](*@\label{code:tempex:negadj:2}@*)
