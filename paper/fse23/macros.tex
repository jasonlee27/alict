...
\newcommand{\tNumTestCases}{\textbf{\#Test\_Cases}}
\newcommand{\tAvgLabelCons}{\textbf{Label\_Consistency}}
\newcommand{\tAvgLCRel}{\textbf{LC\_Relevancy}}
...
\newcommand{\tNumFail}{\textbf{\tool \#Fail}}
\newcommand{\tFailRate}{\textbf{\tool Fail rate[\%]}}
...
\newcommand{\CklstTemplateFigCaption}{Example of \Cklst templates on the \lc of \SareqExThree.\label{code:TempEx}\vspace{-5pt}}
\newcommand{\PdrSelfbleuFigCaption}{Results of \selfbleu(left) and \Pdr(right) of \tool and \Cklst test cases.\label{fig:PdrSelfbleu}\vspace{-10pt}}
\newcommand{\PdrBarplotFigCaption}{Results of \pdr between \tool with 50 seeds and \Cklst test cases.\label{fig:PdrBarplot}\vspace{-5pt}}
...
\newcommand{\FailModelsFigCaption}{Number of failure (left) and \Ptf(right) results of NLP models on \tool test cases over numbers of seeds.\label{fig:FailModels}\vspace{-5pt}}

\newcommand{\SareqExThree}{``Sentiment change over time, present should prevail"}

%% Table Caption
\newcommand{\ReqTableCaption}{Search rules and transformation templates for linguistic capabilities.\label{tab:specification}\vspace{\ReqTableVSpace}}
...
\newcommand{\ManualStudyTableCaption}{Manual
study results of label consistency and \lc relevancy of \tool generated
test cases compared to human annotations.\label{table:ManualStudy}}
...
\Dbert models are denoted as BERT, RoBERTa and dstBERT,
respectively.\label{table:TestResult}}
...
\Dbert models are denoted as BERT, RoBERTa and dstBERT,
respectively.\label{table:TestResultAll}}
\newcommand{\TestResultsBlTableCaption}{Results of \Bert, \Roberta and
\Dbert \sa models on \Cklst test cases. \Bert, \Roberta and
\Dbert models are denoted as BERT, RoBERTa and dstBERT,
respectively.\label{table:TestResultBl}}
\newcommand{\TestResultsHsTableCaption}{Results of \Bert, da-ELECTRA and
da-\Bert hate speech detection models on \tool test cases using all
seeds.\label{table:TestResultHs}}
\newcommand{\TestResultsHsBlTableCaption}{Results of \Bert, da-ELECTRA and
da-\Bert hate speech detection models on HateCheck test
cases.\label{table:TestResultHsBl}}
...
\input{tables/test-results-bl-numbers}
\input{tables/test-results-hs-all-numbers}
\input{tables/test-results-hs-bl-all-numbers}
