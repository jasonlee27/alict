...
\sw{@Jaeseong: rewrite the next two paragraphs to reflect the updated
  manual study. Also, be explicit about the setup: sample size,
  population size, number of participants, protocol (each given how
  many sentences, and how disagreement is resolved), etc.}
