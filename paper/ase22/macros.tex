...
\newcommand{\tAvgLCRel}{\textbf{Sent\_Relevancy}}
...
\newcommand{\RunningExCaption}{Example of sentence expansion.\label{fig:ExpEx}}
\newcommand{\CklstTemplateFigCaption}{Example of \Cklst templates on the \lc of \SareqExThree.\label{code:TempEx}}
...
\Dbert \sa models on \tool test cases. \Bert, \Roberta and
