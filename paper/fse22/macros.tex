...
\newcommand{\shiyi}[1]{\textcolor{purple}{SW: #1}}
...
\newcommand{\req}{requirement\xspace}
\newcommand{\SareqExOne}{``Short sentences with neutral and nouns''\xspace}
...
\newcommand{\Chlst}{CHECKLIST\xspace}
...
%% Fig Caption
\newcommand{\OverallModelFigCaption}{Overall diagram of \Model.\label{fig:OverallModel}}
...
\newcommand{\TransformRequirementExampleFigCaption}{Transform requirement
on the linguistic capability of \SareqExTwo.\label{fig:TransformReqEx}}
