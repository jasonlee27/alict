...
\newcommand{\Mlm}{Masked langauge model\xspace}
\newcommand{\mlm}{masked langauge model\xspace}
\newcommand{\ie}{i.e.\xspace}
\newcommand{\etal}{et al.\xspace}

\newcommand{\src}{source code\xspace}
\newcommand{\Src}{Source code\xspace}
\newcommand{\pl}{programming language\xspace}
\newcommand{\Pl}{Programming language\xspace}
\newcommand{\pls}{programming languages\xspace}
\newcommand{\PL}{Programming Language\xspace}
\newcommand{\sota}{state-of-the-art\xspace}
\newcommand{\Ast}{AST\xspace}
\newcommand{\Py}{Python\xspace}
\newcommand{\ds}{downstream\xspace}
\newcommand{\Ds}{Downstream\xspace}
\newcommand{\Ccd}{Code clone detection\xspace}
\newcommand{\ccd}{code clone detection\xspace}
\newcommand{\Ctr}{Code transtion\xspace}
\newcommand{\ctr}{code transtion\xspace}
\newcommand{\Cref}{Code refinement\xspace}
\newcommand{\cref}{code refinement\xspace}
\newcommand{\csum}{code summarization\xspace}
\newcommand{\cgen}{code generation\xspace}
\newcommand{\bccb}{BigCloneCodeBench\xspace}
\newcommand{\Fone}{F1-score\xspace}
\newcommand{\fone}{f1-score\xspace}   
\newcommand{\Bleu}{BLEU\xspace}
\newcommand{\Xmatch}{xMatch\xspace}
...
\newcommand{\Tf}{T5\xspace}
\newcommand{\graphcodebert}{GraphCodeBERT\xspace}
\newcommand{\graphcodebertcfg}{GraphCodeBERT+\Cfg\xspace}
\newcommand{\CfgDistnodeModel}{Dir\Cfg+dist+node}
\newcommand{\CfgUndirDistnodeModel}{Undir\Cfg+dist+node}
\newcommand{\CfgUndirDistModel}{Undir\Cfg+dist}
...
\newcommand{\PythonIntroExampleFigCaption}{
    An example \Py code snippet(\ref{fig:PythonCodeExample}) and its \Ast(\ref{fig:PythonAstExample}).\label{fig:PythonIntroExample}}
