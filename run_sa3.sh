...
function make_plots() {
        (cd ${_DIR}
         ...
         # python -m python.sa.main --run plots --which test-results
...
function main_sst() {
        ...
        # gen_templates # to generate cfg_expanded_inputs_{nlp_task}_{search_dataset_name}_{selection_method}.json
